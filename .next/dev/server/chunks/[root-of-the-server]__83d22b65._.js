...
async function createClient() {
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$supabase$2f$ssr$2f$dist$2f$module$2f$createServerClient$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["createServerClient"])(("TURBOPACK compile-time value", "https://zazmtkkhtximhjvscggk.supabase.co"), ("TURBOPACK compile-time value", "sb_publishable_fzGky4VSYtTD9x2_e8OUzw_rk1-uBO9"), {
        cookies: {
            getAll () {
...
"[project]/app/api/upload-wood-profile/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    try {
        ...
        const { data, error } = await supabase.from("wood_profiles").insert(cleaned).select("id");
        if (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__83d22b65._.js.map